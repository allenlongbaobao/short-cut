...
var ShortCut = /** @class */ (function () {
  ...
  ShortCut.prototype.handlerKeyUpOrDown = function (event, map, showContent) {
    var e_1, _a;
    if (showContent === void 0) {
      showContent = true;
    }
    var keySets = map.keys();
    var _b = this.option,
      preventDefault = _b.preventDefault,
      duration = _b.duration;
    try {
      for (
        var keySets_1 = __values(keySets), keySets_1_1 = keySets_1.next();
        !keySets_1_1.done;
        keySets_1_1 = keySets_1.next()
      ) {
        var keySet = keySets_1_1.value;
        var _c = keySet.showTip,
          showTip = _c === void 0 ? true : _c;
      ...
      try {
        if (keySets_1_1 && !keySets_1_1.done && (_a = keySets_1.return))
          _a.call(keySets_1);
      } finally {
  ...
  ShortCut.prototype.getContent = function (keyData, event) {
    var _this = this;
    var _a = keyData.content,
      content = _a === void 0 ? "" : _a,
      assistArray = keyData.assistArray;
    var prefix = "";
    if (assistArray) {
      var assist = assistArray.find(function (a) {
        return _this.assistMatchMethod(a, event);
      });
  ...
  ShortCut.prototype.checkKeyExist = function (keyData, map) {
    ...
    try {
      // 每个属性对比是否一致
      for (
        var _b = __values(map.keys()), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var keySet = _c.value;
  ...
  ShortCut.prototype.checkAssistKeyMatch = function (keySet, event) {
    ...
    if (assistArray && assistArray.length) {
      try {
        ...
        for (
          var assistArray_1 = __values(assistArray),
            assistArray_1_1 = assistArray_1.next();
          !assistArray_1_1.done;
          assistArray_1_1 = assistArray_1.next()
        ) {
        ...
        try {
          if (
            assistArray_1_1 &&
            !assistArray_1_1.done &&
            (_a = assistArray_1.return)
          )
            _a.call(assistArray_1);
        } finally {
